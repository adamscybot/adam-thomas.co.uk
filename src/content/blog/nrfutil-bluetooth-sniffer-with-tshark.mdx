...
> [!NOTE]  
> tl;dr? Jump to either the <Icon name="icomoon-free:windows" class={css({ w: "4", mt: "[-3px]", display: 'inline-block', verticalAlign: 'middle' })} /> [Windows](#basic-poc-solution) or <Icon name="icomoon-free:tux" class={css({ w: "4", mt: "[-3px]", display: 'inline-block', verticalAlign: 'middle' })} /> [Unix/Linux/Mac](#unix) solution.
